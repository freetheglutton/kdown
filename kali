...
#Download URLs
URL1="https://kali.download/arm-images/kali-2022.1/kali-linux-2022.1-raspberry-pi-arm64.img.xz"
...
options=("Kali" "Raspberry Pi OS Basic Desktop" "Raspberry Pi OS Lite" "All Raspberry Pi OS Builds" "Exit")
...
clear
echo ""
echo "#### CONVERTING Kali IMAGE TO BERRYBOOT ####"
echo ""
